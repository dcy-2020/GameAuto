...
CONFIG_HELP = {
    ...
    "global_task_timeout": ("超时 - 全局超时(秒)", "单个任务最大允许运行时间"),
...
CONFIG_GROUPS = {
    "general": {
        ...
        "keys": [
            ...
            "log_timeout", "global_task_timeout", "retry_wait",
            "boot_max_wait", "cleanup_wait_first", "cleanup_wait_check",
            "window_activate_wait", "process_start_wait",
        ],
    },
    "okww": {
        "label": "鸣潮",
